...
def zhengjie(path_1):
    ...
    for filename in os.listdir(path):
        ...
        for y in mingdan:
            ...
            if fenkai[0] == 'l':
                zhengjie_xuhao_b_1.append(int(fenkai[1]))
                zhengjie_xuhao_b_2.append(int(fenkai[2]))

            elif fenkai[0] == 'r':
                zhengjie_xuhao_a_1.append(int(fenkai[1]))
                zhengjie_xuhao_a_2.append(int(fenkai[2]))
        ...
        for n in range(len(b)):
            ...
            if b[n] != '':
                ...
                if b[n][0] == 'B':  # 记住B是left
                    ...
                    b[n + 2][0] = b[n + 2][0].replace('。', '')

                    if int(b[n + 1][0]) in zhengjie_xuhao_b_1 and int(b[n + 2][0]) in zhengjie_xuhao_b_2:
                    ...
                    if int(b[n + 1][0]) in zhengjie_xuhao_a_1 and int(b[n + 2][0]) in zhengjie_xuhao_a_2:
                        # print(b[n+1][0])
