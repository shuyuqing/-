...
def zhengli(path):
    ...
    for wenjian in os.listdir(path):
        ...
        if wenjian != 'data':
            ...
            path_2 = os.path.join(path_1,'xinde_log_1')
            path_3 = os.path.join(path_1,'xinde_mizhichuli_1')
            ...
            if len(wenjian_mizhichuli_all) == len(wenjian_fbank_all):
