def _make_kana_convertor(text1):#可以把英语字母转化为片假名
    ...
    kata = {
        'A': 'えい', 'a': 'えい','B': 'びー', 'b': 'びー', 'C': 'しー',
        'c': 'しー', 'D': 'でぃー', 'd': 'でぃー', 'E': 'いー', 'e': 'いー',
        'F': 'えふ', 'f': 'えふ', 'G': 'じー', 'g': 'じー', 'H': 'えっち',
        'h': 'えっち', 'I': 'あい', 'i': 'あい', 'J': 'じぇい', 'j': 'じぇい',
        'K': 'けい', 'k': 'けい', 'L': 'える', 'l': 'える', 'M': 'えむ',
        'm': 'えむ', 'N': 'えぬ', 'n': 'えぬ', 'O': 'おー', 'o': 'おー',
        'P': 'ぴー', 'p': 'ぴー', 'Q': 'きゅー', 'q': 'きゅー', 'R': 'あーる',
        'r': 'あーる', 'S': 'えす', 's': 'えす', 'T': 'てぃー', 't': 'てぃー',
        'U': 'ゆー', 'u': 'ゆー', 'V': 'ヴい', 'v': 'ヴい', 'W': 'だぶりゅー',
        'w': 'だぶりゅー','X': 'えっくす', 'x': 'えっくす', 'Y': 'わい', 'y': 'わい',
        'Z': 'ずぃー','z': 'ずぃー','〇':'れい','ω':'おめが'
    }
    #要转ひらがな就用上面这个
    #打字打Z的时候，ＺＵ＋ＬＩ
