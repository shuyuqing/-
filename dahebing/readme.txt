...
quci_RWCP_SP96_yinsu:#把正解文转化为音素(生成待转化文件)，生成正解文和识别结果(音素)的文本...n个函数被合并了
pinjia:#把正解文转化为音素(生成带转化文件)
...
chongzao_crnn_yinsu:#crnn用的在音素上打标签的重造[['s', [6, 10], 'C'], ['a', [11, 20], 'C'], ['q', [21, 26], 'C']的文本
