...
# bl.kongwenjian(path,guanjianzi='xinde_log_zhengzehua_1')#把大小为0的文件都删除了
# bl.kongwenjian(path,guanjianzi='xinde_mizhichuli_zhengzehua_1')#把大小为0的文件都删除了




# bl.pingheng(path,guanjianzi='xinde_log_zhengzehua_1')#把标签全部是0的文件都移动到桌面去
# bl.pingheng(path,guanjianzi='xinde_mizhichuli_zhengzehua_1')#把标签全部是0的文件都移动到桌面去




# bl.pingheng_1(path,guanjianzi='xinde_log_zhengzehua_1')#把标签全部是1的文件都移动到桌面上去
# bl.pingheng_1(path,guanjianzi='xinde_mizhichuli_zhengzehua_1')#把标签全部是1的文件都移动到桌面去
...
#
#     path_1 = os.path.join(path, wenjian, 'xinde_log_zhengzehua_1')
#     path_new = os.path.join(path, wenjian, 'xinde_log_pingheng_zhengzehua_1')
#
#     mu.mkdir(path_new)
#
...
# bl.kongwenjian(path,guanjianzi='xinde_log_pingheng_zhengzehua_1')#把大小为0的文件都删除了
# bl.pingheng(path,guanjianzi = 'xinde_log_pingheng_zhengzehua_1')#把标签全部是0的文件都移动到桌面去,因为切割之后会留下很多标签全是0的文件




# for wenjian in os.listdir(path):#因为特征值里面0太多了，要切掉一些，这个会把文件切成不同小段
#     path_1 = os.path.join(path, wenjian, 'xinde_mizhichuli_zhengzehua_1')
#     path_new = os.path.join(path, wenjian, 'xinde_mizhichuli_pingheng_zhengzehua_1')
#
#     mu.mkdir(path_new)
#
#     for wenjian_1 in os.listdir(path_1):
...
# bl.kongwenjian(path,guanjianzi = 'xinde_mizhichuli_pingheng_zhengzehua_1')#把大小为0的文件都删除了
# bl.pingheng(path,guanjianzi = 'xinde_mizhichuli_pingheng_zhengzehua_1')#把标签全部是0的文件都移动到桌面去,因为切割之后会留下很多标签全是0的文件




# zhengli.zhengli(path,guanjianzi_1='xinde_log_pingheng_zhengzehua_1',guanjianzi_2 = 'xinde_mizhichuli_pingheng_zhengzehua_1')#把opentest,closetest,整理出来
...
# ps.pishan(path,guanjianzi='xinde_log_pingheng_zhengzehua',guanjianzi_1 = 'mulu')#批量删除文件夹下的一些东西，注意，第二个关键字根据要删除的是文件（wenjian）还是目录(mulu)来决定
# ps.pishan(path,guanjianzi='xinde_log_zhengzehua',guanjianzi_1 = 'mulu')#批量删除文件夹下的一些东西，注意，第二个关键字根据要删除的是文件（wenjian）还是目录(mulu)来决定
# ps.pishan(path,guanjianzi='xinde_mizhichuli_pingheng_zhengzehua',guanjianzi_1 = 'mulu')
# ps.pishan(path,guanjianzi='xinde_mizhichuli_zhengzehua',guanjianzi_1 = 'mulu')
# ps.pishan(path,guanjianzi='mizhichuli_log_zhengzehua',guanjianzi_1 = 'mulu')
# ps.pishan(path,guanjianzi='log_zhengzehua',guanjianzi_1 = 'mulu')
