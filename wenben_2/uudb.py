#此文件是uudb专用的用来取出正解文的文本，把L和R两个部分的文件分开
import csv
#原来csv这个包是可以处理txt文件的
import os

file_dir=r"C:\Users\a7825\Desktop\工作空间\杂物\第一批\C004L\新建文件夹/"
#原文件的路径
new_dir1=r"C:\Users\a7825\Desktop\工作空间/"
new_dir2=r"C:\Users\a7825\Desktop\工作空间/"
#处理过后的新文件的路径
#这两个路径最后的‘/’不能省略
for feature in os.listdir(file_dir):
    files_dir=file_dir+feature
    news_dir1=new_dir1+'L'+feature
    news_dir2=new_dir2+'R'+feature
